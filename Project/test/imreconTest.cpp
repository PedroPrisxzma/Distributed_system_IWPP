...
int main(int argc, char **argv)
{
	...
	recon = nscale::imreconstruct<unsigned char>(0, bQueue, marker, mask, 4, xQueue, yQueue);
	...
	// t1 = cci::common::event::timestampInUS();
	// recon = nscale::imreconstruct<unsigned short int>(0, xQueue, marker, mask, 4, xQueue, yQueue);
	// t2 = cci::common::event::timestampInUS();
	// std::cout << " cpu recon4 took " << t2-t1 << "ms" << std::endl;
